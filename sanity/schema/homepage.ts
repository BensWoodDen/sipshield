...
export const homepage = defineType({
  ...
  fields: [
    defineField({
      ...
      type: "object",
      fields: [
        defineField({ name: "kicker", title: "Kicker", type: "string", initialValue: "From Ben's workshop in Bournemouth" }),
        defineField({ name: "headline", title: "Headline", type: "string", initialValue: "A proper cover for your drink" }),
        defineField({ name: "body", title: "Body Text", type: "text", rows: 3 }),
        defineField({ name: "ctaLabel", title: "CTA Button Label", type: "string", initialValue: "See the range" }),
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: "linkText", title: "Link Text", type: "string", initialValue: "More about Ben" }),
